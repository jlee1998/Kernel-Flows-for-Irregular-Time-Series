...
def LorenzExp(learning = True):
    num_repeats = 5
    train_data, test_data, delays_train, delays_test = generate_Lorenz_data()
    ...
    for rep in range(num_repeats):
        mse_pred_o, r2_pred_o = original_kernel_flow(train_data,test_data,n_parameters=24, delay = 2, regu_lambda = 0.00001, lr = 0.01, horizon = 20, dim = 3, epochs = epochs)
        mse_pred_i, r2_pred_i = irregular_kernel_flow(train_data,test_data, delays_train, delays_test, n_parameters=24, delay = 2, regu_lambda = 0.00001, lr = 0.01, horizon = 20, dim = 3, epochs = epochs)
...
def HenonExp(learning = True):
    num_repeats = 5
    train_data, test_data, delays_train, delays_test = generate_Henon_data()
    ...
    r2_i_not_learned = []
    for rep in range(num_repeats):
        mse_pred_o, r2_pred_o = original_kernel_flow(train_data,test_data,n_parameters=24, delay = 1, regu_lambda = 0.00001, lr = 0.1, horizon = 5, dim = 2, epochs = epochs)
        mse_pred_i, r2_pred_i = irregular_kernel_flow(train_data,test_data, delays_train, delays_test, n_parameters=24, delay = 1, regu_lambda = 0.00001, lr = 0.1, horizon = 5, dim = 2, epochs = epochs)
        mse_o.append(mse_pred_o)
        mse_i.append(mse_pred_i)
        r2_o.append(r2_pred_o)
        r2_i.append(r2_pred_i)
...
def VDPExp(learning = True):
    num_repeats = 5
    train_data, test_data, delays_train, delays_test = generate_VDP_data()
    ...
    r2_i_not_learned = []
    for rep in range(num_repeats):
        mse_pred_o, r2_pred_o = original_kernel_flow(train_data,test_data,n_parameters=24, delay = 1, regu_lambda = 0.00001, lr = 0.01, horizon = 10, dim = 2, epochs = epochs)
        mse_pred_i, r2_pred_i = irregular_kernel_flow(train_data,test_data, delays_train, delays_test, n_parameters=24, delay = 1, regu_lambda = 0.00001, lr = 0.01, horizon = 10, dim = 2, epochs = epochs)
        mse_o.append(mse_pred_o)
        mse_i.append(mse_pred_i)
        r2_o.append(r2_pred_o)
        r2_i.append(r2_pred_i)
...
if __name__=="__main__":
    ...
    HenonExp(learning = False)
    #VDPExp(learning = False) 
    #LorenzExp(learning = False)
